...
-o, --output	: Output filename <filename> (to write to stdout, use '-o -').
		  ...
		  (e.g. raspvid -l -o tcp://0.0.0.0:3333 -> bind to all network interfaces, raspvid -l -o tcp://192.168.1.1:3333 -> bind to a certain local IPv4)
...
User MP4Box to convert raspivid H264 video to MP4
...
Reference: [Raspivid](https://www.raspberrypi.org/documentation/usage/camera/raspicam/raspivid.md)
